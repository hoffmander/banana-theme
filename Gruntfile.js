module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
      ...
      my_target: {
        files: {
          'js/functions.compiled.js': ['js/dev/functions.js', 'js/vendor/*.js']
        }
      }
    },
    ...
    scaffold: {
        component: {
            options: {
                ...
                template: {
                    "components/skeleton.php": "components/{{name}}/_{{name}}.php",
                    "components/skeleton.scss": "components/{{name}}/_{{name}}.scss"                    
                }
            }
        }
    }
